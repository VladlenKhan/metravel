      ...
      <div className="relative mx-auto px-5 sm:px-8 lg:px-12 max-w-7xl w-full mt-17">
        <div className="max-w-4xl">
          ...
          <div className="flex flex-col sm:flex-row gap-5">
            <a href="#find" className="px-8 py-5 bg-amber-500 hover:bg-amber-600 text-white text-lg font-semibold rounded-xl shadow-xl hover:shadow-2xl transform hover:-translate-y-1 transition-all duration-300">
              Подобрать тур
            </a>
